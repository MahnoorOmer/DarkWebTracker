...
export default function SourcesDisplay() {
  const [scrapeActive, setScrapeActive] = useState(true);
  ...
  const totalRecords = sources.reduce((sum, source) => sum + source.recordsCollected, 0);
    ...
    <Card className="border-neutral-dark bg-secondary">
      ...
      <CardContent className="p-0">
        ...
        <div className="divide-y divide-neutral-dark">
          {sources.map((source) => (
            <div key={source.id} className="p-4 hover:bg-background/20 transition-colors">
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <div className={`rounded-full p-2 mr-3 ${ 
                    source.type === "forum" ? "bg-primary/20" :
